...
\usepackage[hyphenbreaks]{breakurl}         % must come after hyperref 
...
\begin{figure}
  \centering
    \includegraphics[scale=0.55]{images/hash.png}
  \caption{Hash Ring}
  \label{hash}
\end{figure}
...
\begin{figure}
  \centering
    \includegraphics[scale=0.45]{images/storage_format.png}
