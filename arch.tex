...
Our partitioning scheme is similar to Dynamo's, where-in
...
replicas will be stored), we first hash the key to a range belonging
...
every node also runs a service that allows the execution of following
administrative commands: add or removal of a store, stream data out,
