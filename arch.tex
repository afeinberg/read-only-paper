...
in degrading the serving latency. Since our data is static the 
na\"{i}ve way to solve this problem is to start a new larger cluster,
re-push the data and switch the clients over. Unfortunately this
requires massive co-ordination when dealing with 100+ clients talking
to 100+ stores.
