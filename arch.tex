...
good state.
\item \emph{Handle large data-sets}.  
\end{compactitem}
...
input the cluster topology, store definition and the input data 
location on HDFS and then takes care of replication and partitioning,
finally emitting the data into separate node based folders. 
