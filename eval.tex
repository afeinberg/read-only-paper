...
evident, MySQL exhibits extremely slow build times since it buffers
the changes to the index before flushing it to disk. Also a simple
I/O benchmark run during the test shows that MySQL outputs around 
1.4 times more data over a longer period of time. The optimized B$^{+}$, on the other hand,
